...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'f4aad9ed66184e0eabda79e5b7f84320',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'yacheng', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个量化打工人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://website.yacheng.xyz/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'yiaoaoao9@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  MUSIC_PLAYER_METING_ID:
        process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '9181781872', // 对应歌单的 id
